package com.fatec.destino.util.model.usuario.senha
...
object SenhaValidator {
    ...
    // $                   # Fim da string
    private const val SENHA_COMPLEXA_REGEX = "^(?=.*[0-9])(?=.*[a-z])(?=.*[A-Z])(?=.*[!@#$%^&*()_+\\-]).{8,}$"

    private val PATTERN: Pattern = Pattern.compile(SENHA_COMPLEXA_REGEX)
